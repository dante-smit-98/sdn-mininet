...
def startmn():
    ...
    #print result
    result = h1.cmd('iperf -s -u -p 5566 -i 4 &')
    #print result
    result = h1.cmd('iperf -s -u -p 5567 -i 4 &')
    #print result
    result = h1.cmd('iperf -s -u -p 5568 -i 4 &')
    
    result = h2.cmd('firefox -P --no-remote &')
    result = h3.cmd('firefox -P --no-remote &')
    result = h4.cmd('firefox -P --no-remote &')

    result = h2.cmd('iperf -c 10.0.0.1 -u -b 1M -t 250 -p 5566 &')
    result = h3.cmd('iperf -c 10.0.0.1 -u -b 1M -t 250 -p 5567 &')
    result = h4.cmd('iperf -c 10.0.0.1 -u -b 1M -t 250 -p 5568 &')
    CLI(net)
    net.stop()
